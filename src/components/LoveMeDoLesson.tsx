          ...
          <CardContent className="p-0">
            ...
            <div className="grid md:grid-cols-3 gap-6 2xl:gap-8 3xl:gap-12 mb-6 2xl:mb-8">
              <div className="flex flex-col items-center">
                <h3 className="text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-gray-800 mb-4">G</h3>
              ...
              <div className="flex flex-col items-center">
                <h3 className="text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-gray-800 mb-4">C</h3>
              ...
              <div className="flex flex-col items-center">
                <h3 className="text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-gray-800 mb-4">D</h3>
        ...
        <Card className="p-6 2xl:p-8 3xl:p-10 shadow-xl border-2 border-orange-200 bg-white/90 backdrop-blur-sm mb-8 2xl:mb-12 3xl:mb-16">
          <CardContent className="p-0">
            ...
            <div className="space-y-4 2xl:space-y-6 3xl:space-y-8">
              ...
              <div>
                <p className="text-base 2xl:text-lg 3xl:text-xl text-gray-700 mb-2">
                  <strong>{t('content.bonus.strumming_pattern')}</strong> {t('content.bonus.strumming_pattern_desc')}
                </p>
              </div>
