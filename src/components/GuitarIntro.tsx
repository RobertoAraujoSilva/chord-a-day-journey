...
const STRING_FREQUENCIES = {
  ...
  A5: 110.0, // 5th string - A
  D4: 146.83, // 4th string - D
  G3: 196.0, // 3rd string - G
...
export const GuitarIntro = ({ onComplete, isCompleted }: GuitarIntroProps) => {
  ...
  const playString = async (stringName: string, frequency: number) => {
    ...
    try {
      ...
      const pluckBuffer = createPluckedString(
        audioContext,
        frequency,
        duration,
        0.5
  ...
  const toggleChecklistItem = (item: keyof typeof checklist) => {
    ...
    console.log(
      "Todos marcados?",
      Object.values(newChecklist).every((v) => v)
    );
  };
              ...
              <div className="space-y-4 2xl:space-y-5">
                ...
                <div className="flex items-center justify-between gap-4 p-4 2xl:p-5 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors border border-gray-200 hover:border-orange-300">
                  ...
                  >
                    ...
                    <span className="text-sm 2xl:text-base font-semibold">
                      {playingString === "E6" ? "..." : t("ui.labels.play")}
                    </span>
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between gap-4 p-4 2xl:p-5 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors border border-gray-200 hover:border-orange-300">
                  ...
                  >
                    ...
                    />
                    <span className="text-sm 2xl:text-base font-semibold">
                      {playingString === "A5" ? "..." : t("ui.labels.play")}
                    </span>
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between gap-4 p-4 2xl:p-5 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors border border-gray-200 hover:border-orange-300">
                  ...
                  >
                    ...
                    />
                    <span className="text-sm 2xl:text-base font-semibold">
                      {playingString === "D4" ? "..." : t("ui.labels.play")}
                    </span>
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between gap-4 p-4 2xl:p-5 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors border border-gray-200 hover:border-orange-300">
                  ...
                  >
                    ...
                    />
                    <span className="text-sm 2xl:text-base font-semibold">
                      {playingString === "G3" ? "..." : t("ui.labels.play")}
                    </span>
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between gap-4 p-4 2xl:p-5 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors border border-gray-200 hover:border-orange-300">
                  ...
                  >
                    ...
                    />
                    <span className="text-sm 2xl:text-base font-semibold">
                      {playingString === "B2" ? "..." : t("ui.labels.play")}
                    </span>
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between gap-4 p-4 2xl:p-5 bg-gray-50 rounded-lg hover:bg-orange-50 transition-colors border border-gray-200 hover:border-orange-300">
                  ...
                  >
                    ...
                    />
                    <span className="text-sm 2xl:text-base font-semibold">
                      {playingString === "E1" ? "..." : t("ui.labels.play")}
                    </span>
                  </Button>
                </div>
              </div>
                ...
                <p className="text-sm 2xl:text-base font-semibold text-gray-900">
                  {allChecked
                    ...
                    : `⚠️ Marque ${4 - checkedCount} ${
                        4 - checkedCount === 1 ? "checkbox" : "checkboxes"
                      } restante${
                        4 - checkedCount === 1 ? "" : "s"
                      } para desbloquear o botão.`}
                </p>
              </div>
            </CardContent>
          </Card>
